...
DOCKERFILE_PATH="$ROOT_DIR/infra/images/api/Dockerfile"
REPO_URI="$AWS_ACCOUNT_ID.dkr.ecr.$AWS_REGION.amazonaws.com/talon-dev/api"
...
echo "Pushed api image: $REPO_URI:$TAG ($PLATFORM)"
